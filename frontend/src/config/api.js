...
// Prefer Vite-provided `VITE_API_URL`, otherwise default to localhost for local development.
const API_BASE_URL = (import.meta.env && import.meta.env.VITE_API_URL) || 'http://localhost:7700';
